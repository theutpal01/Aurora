...
const Navbar = ({ theme }: { theme: "primary" | "secondary" }) => {
	...
	return (
		<>
			{!pathname.includes("/login") && <nav className={`fixed bottom-0 left-0 w-full z-50 ${themes[theme]} h-20 flex *:flex overflow-hidden justify-around bg-background items-end *:h-full *:justify-center *:items-center rounded-t-2xl *:w-full *:duration-400`}>
